            ...
            <motion.div variants={cardVariants} initial="initial" animate="animate" transition={{ delay: 0.4, duration: 0.5 }}>
                <Link href="/donor">
                    <Card className="group transform cursor-pointer transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-2xl hover:border-primary">
                        ...
                        <CardContent>
                            <p className="text-muted-foreground">Share your surplus food and make a difference in your community.</p>
                            <div className="mt-6 flex items-center justify-center text-primary transition-transform duration-300 group-hover:translate-x-1">
            ...
            <motion.div variants={cardVariants} initial="initial" animate="animate" transition={{ delay: 0.6, duration: 0.5 }}>
                <Link href="/receiver">
                    <Card className="group transform cursor-pointer transition-all duration-300 ease-in-out hover:-translate-y-2 hover:shadow-2xl hover:border-primary">
                        ...
                        <CardContent>
                            <p className="text-muted-foreground">Find available food donations near you from generous donors.</p>
                             <div className="mt-6 flex items-center justify-center text-primary transition-transform duration-300 group-hover:translate-x-1">
                                <span className="font-semibold">Find Food</span>
                                <ArrowRight className="ml-2 h-5 w-5" />
                            </div>
                        </CardContent>
                    </Card>
